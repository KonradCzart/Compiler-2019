...
#line 128 "parser.tab.hh" // lalr1.cc:377
  ...
  basic_symbol (typename Base::kind_type t, const std::string v, const location_type& l);
    ...
    static inline
    symbol_type
    make_ENDSCANN (const location_type& l);
    ...
    static inline
    symbol_type
    make_GREAT (const location_type& l);
    ...
    static inline
    symbol_type
    make_GREATEQ (const location_type& l);
    ...
    Parser (Scanner  &scanner_yyarg, CompilerDriver  &driver_yyarg);
    virtual ~Parser ();
...
#line 835 "parser.tab.hh" // lalr1.cc:377
